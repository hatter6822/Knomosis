...
/-
LegalKernel.Laws.ExampleLex — the M1 acceptance Lex law.
...
keywords (cf. `LegalKernel.DSL.LexLaw` v1-deviation note), and
emits:
  ...
  * a `LegalKernel/_lex_inputs/example_example_lex_only_law.json`
...
`LegalKernel/_lex_inputs/example_example_lex_only_law.json`
...
namespace LegalKernel.Laws.Example
...
`LegalKernel/_lex_inputs/example_example_lex_only_law.json` is
