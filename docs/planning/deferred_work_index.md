...
| `unified_gas_pool_plan.md` | GP — unified gas pool + actor budgets | 12 phases (~80+) | ~20+ wks | active workstream (GP.0 in progress) | foundational for P7 variable-cost action economics |
