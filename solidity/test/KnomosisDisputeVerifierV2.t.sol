...
contract KnomosisDisputeVerifierV2Test is Test {
    KnomosisDisputeVerifierV2 private verifier;
    ...
    function setUp() public {
        ...
        verifier = new KnomosisDisputeVerifierV2(
            faultProofGame,
    ...
    function test_constructor_rejects_zero_quorum() public {
        vm.expectRevert(KnomosisDisputeVerifierV2.QuorumThresholdZero.selector);
        new KnomosisDisputeVerifierV2(
            faultProofGame, address(stateRootSubmission), adjudicators,
    ...
    function test_constructor_rejects_quorum_above_set_size() public {
        vm.expectRevert(
          KnomosisDisputeVerifierV2.QuorumThresholdAboveSetSize.selector);
        new KnomosisDisputeVerifierV2(
            faultProofGame, address(stateRootSubmission), adjudicators,
    ...
    function test_finaliseFromQuorum_below_quorum_rejected() public {
        ...
        vm.expectRevert(
          abi.encodeWithSelector(
            KnomosisDisputeVerifierV2.InsufficientQuorum.selector, 1, 2));
        verifier.finaliseFromQuorum(id, VERDICT_UPHELD, signers, sigs);
    }
    ...
    function test_finaliseFromQuorum_unsigned_listing_rejected() public {
        ...
        vm.expectRevert(
          abi.encodeWithSelector(
            KnomosisDisputeVerifierV2.InsufficientQuorum.selector, 0, 2));
        verifier.finaliseFromQuorum(id, VERDICT_UPHELD, signers, sigs);
    }
    ...
    function test_finaliseFromQuorum_mismatched_lengths_rejected() public {
        ...
        vm.expectRevert(
          KnomosisDisputeVerifierV2.SignerSignatureCountMismatch.selector);
        verifier.finaliseFromQuorum(id, VERDICT_UPHELD, signers, sigs);
    }
    ...
    function test_finaliseFromQuorum_too_many_signers_rejected() public {
        ...
        vm.expectRevert(
          abi.encodeWithSelector(
            KnomosisDisputeVerifierV2.TooManySigners.selector, n, 64));
        verifier.finaliseFromQuorum(id, VERDICT_UPHELD, signers, sigs);
    }
