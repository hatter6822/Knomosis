...
/// @title KnomosisFaultProofMigrationTest
/// @notice Forge tests for the V1→V2 migration handoff
///         (Workstream-H WU H.9.2).
contract KnomosisFaultProofMigrationTest is Test {
    ...
    function _deployMigration() internal returns (KnomosisFaultProofMigration) {
        ...
        return new KnomosisFaultProofMigration(
            GRACE,
            address(predecessor),
            successor,
            LAST_HASH,
    ...
    function test_constructor_rejects_zero_predecessor() public {
        vm.expectRevert(KnomosisFaultProofMigration.ZeroAddress.selector);
    ...
    function test_constructor_rejects_grace_too_short() public {
        vm.expectRevert(KnomosisFaultProofMigration.GraceTooShort.selector);
        new KnomosisFaultProofMigration(
    ...
    function test_constructor_rejects_predecessor_equals_successor() public {
        ...
        // mock for both.
        vm.expectRevert(
          KnomosisFaultProofMigration.PredecessorEqualsSuccessor.selector);
        new KnomosisFaultProofMigration(
    ...
    function test_constructor_rejects_eoa_successor() public {
        ...
        predecessor.setMigration(expectedAddr);
        vm.expectRevert(
          KnomosisFaultProofMigration.SuccessorNotContract.selector);
        new KnomosisFaultProofMigration(
    ...
    function test_constructor_rejects_predecessor_without_consent() public {
        ...
        vm.expectRevert(
            KnomosisFaultProofMigration.PredecessorDoesNotReferenceThisMigration.selector);
        new KnomosisFaultProofMigration(
    ...
    function test_activate_within_grace_window_rejected() public {
        KnomosisFaultProofMigration m = _deployMigration();
        vm.expectRevert(KnomosisFaultProofMigration.NotYetActivatable.selector);
        m.activate();
    }
