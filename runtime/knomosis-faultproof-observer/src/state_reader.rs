...
//! eth_call-based reader for the `KnomosisFaultProofGame` contract's
...
//! (verified via `forge inspect KnomosisFaultProofGame abi --json`).
...
//! `0x117a5b90` (verified via `forge inspect KnomosisFaultProofGame
...
/// A reader for the `KnomosisFaultProofGame` contract's per-game
...
mod tests {
    ...
    fn selector_matches_solidity_inspector_output() {
        // `forge inspect KnomosisFaultProofGame methods` reports
