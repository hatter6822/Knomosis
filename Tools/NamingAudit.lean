...
def forbiddenTokens : List String :=
  -- Explicit catches for the historical "MissingTheorems" sin
  -- (the bug this audit was created to prevent).
  [ "missingtheorems"
  , "missing_theorems"
  , "missing_theorem"
  , "missingtheorem"
  ...
  , "_draft"
  , "_legacy"
  -- Grab-bag umbrella names (the original sin: non-descriptive
  -- group-by-leftover naming).
  , "miscellaneous"
  , "supplemental"
  , "auxiliary"
  , "addenda"
